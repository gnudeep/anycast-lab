...
# Start socat proxy to forward anycast IP traffic to regionA backend
nohup socat TCP4-LISTEN:80,bind=203.0.113.10,fork,reuseaddr TCP4:10.10.1.10:80 > /var/log/socat.log 2>&1 &

echo "pop1 setup complete"
